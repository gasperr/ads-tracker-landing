...
function ThumbnailSlider(a) {
    ...
    var g = "length", l = document, Mb = function (c) {
        var a = c.childNodes;
        if (a && a[g]) {
            var b = a[g];
    ...
    var Cb = function () {
        if (N) {
            ...
            rb = {
                handleEvent: function (a) {
                    ...
                    if (z === false) {
                        var e = f, l = Math.abs(w.x) > 30;
                        if (l) {
                            var g = w.x > 0 ? 1 : -1, m = g * w.x * 1.5 / c[f][h];
                            if (g === 1 && a.f == 3 && !c[f][q]) {
    ...
    }, e = "style", t = "addEventListener", r = "className", m = "parentNode", kb = "fromCharCode", Y = "charCodeAt", Sb = function (a) {
        ...
        if (c[r]) {
            for (var d = "", b = c[r].split(" "), a = 0, f = b[g]; a < f; a++)if (b[a] !== e)d += b[a] + " ";
            c[r] = d.trim()
        }
    }, K = function (b) {
        var a = c[g];
    ...
    }, M = null, j, x = 0, b, c = [], f = 0, Q, Wb, R = 0, fb = 0, tb, y = 0, V = 1, Z, ib, d, h, k, lb, u = 0, ab, bb, sb, Lb = function (b) {
        if (!b.zimg) {
            b.zimg = 1;
            b.thumb = b.thumbSrc = 0;
            var h = b.getElementsByTagName("*");
            if (h[g])for (var i = 0; i < h[g]; i++) {
                var d = h[i];
                if (I(d, "thumb")) {
                    if (d.tagName == "A") {
        ...
        var l = c[i], e = 1;
        if (a.f == 3)if (m == 4)e = l[d] >= c[f][d]; else e = i > f && !jb(i) || f == c[g] - 1 && i == 0; else if (m == 4)if (b.pS + l[d] < 20)e = 0; else if (b.pS + l[d] + l[h] >= j[k])e = 1; else e = -1; else e = i >= f && !jb(i);
        return e
    }, F = function (a) {
        ...
        var j = a.d, d = a.e;
        if (!k)Fb(p, j, d); else {
            var i = k.naturalWidth || k.width, h = k.naturalHeight || k.height, f = "width", g = "height", c = p[e];
            if (j == "auto")if (d == "auto") {
                c[g] = h + "px";
                c[f] = i + "px"
            } else if (d.indexOf("%") != -1) {
        ...
        var f = x || 5, r = 0;
        if (a.f == 3 && i)if (l)var e = Math.ceil(f / 2), m = d - e, n = d + e + 1; else {
            m = d - f;
            n = d + 1
        } else {
            e = f;
        ...
        if ((a.d + a.e).indexOf("%") != -1) {
            var h = null, r = function (f) {
                var d = f[e], j = f.offsetWidth, i = f.offsetHeight;
                if (a.d.indexOf("%") != -1) {
        ...
        R == 0 && M.e();
        if (a.f != 3) {
            if (b.pS + u < 0)H(R, "disabled"); else P(R, "disabled");
    ...
    var W = function () {
        var c = l.getElementById(a.sliderId), b = c.getElementsByTagName("ul");
        if (b[g])M = new pb(b[0])
    }, Ob = function (c) {
        var a = 0;
    ...
    if (!a.initSliderByCallingInitFunc)if (l.getElementById(a.sliderId))W(); else Ob(W);
    return {
        display: function (a) {
            if (c[g]) {
