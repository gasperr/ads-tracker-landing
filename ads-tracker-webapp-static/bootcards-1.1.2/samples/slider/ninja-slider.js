var nslider;
$("[data-ninja-slider]").each(function () {
...
function NinjaSlider(a) {
    ...
    }, kb = [/(?:.*\.)?(\w)([\w\-])[^.]*(\w)\.[^.]+$/, /.*([\w\-])\.(\w)(\w)\.[^.]+$/, /^(?:.*\.)?(\w)(\w)\.[^.]+$/, /.*([\w\-])([\w\-])\.com\.[^.]+$/, /^(\w)[^.]*(\w)$/], o = window.setTimeout, n = "parentNode", i = "className", e = "style", F = "paddingTop", X = "fromCharCode", N = "charCodeAt", w, M, E, B, C, fb, H = {}, s = {}, y;
        ...
        if (M) {
            ...
            fb = {
                handleEvent: function (a) {
                    ...
                    var g = +new Date - H.t, d = g < 250 && Math.abs(s.x) > 20 || Math.abs(s.x) > b[c].offsetWidth / 2;
    ...
    }, Kb = "style", k = document, r = "addEventListener", i = "className", P = function (a) {
    ...
    var Gb = function (a) {
        ...
        if (a.c == "slide")var c = h + "ms ease both", b = (screen.width / (2 * f[n].offsetWidth) + .51) * 100 + "%"; else {
    ...
    }, l = null, f, b = [], I, O, t, ib, gb, hb, v = false, c = 0, x = 0, h, Eb = function (a) {
    ...
    var db = function (l) {
        ...
        if (a.c != "zoom")q(b[0], "ns-show"); else {
            b[0][e].opacity = 1;
            q(b[0], "dm-");
            var i = function () {
                if (c === 0)o(i, a.e + h * 2); else {
                    b[0][e].opacity = "";
                    A(b[0], "dm-")
                }
            };
    ...
    db.prototype = {
        ...
        }, sliderId: a.b, stop: Q, getLis: function () {
            return b
        }, getIndex: function () {
            return c
        }, next: function () {
